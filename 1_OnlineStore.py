#This Code only works when new account is created on site123
#For already created account different code is needed
...
#Creating site
driver.find_element(By.XPATH, '//button[@class="btn btn-primary  dropdown-toggle"]').click()
time.sleep(2)
...
driver.find_element(By.XPATH, '//div[@data-cat-id="33"]').click()
time.sleep(2)
#Enter online store name
n = "Venom's Shop"
